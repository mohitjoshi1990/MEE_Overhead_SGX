...
static sgx_status_t SGX_CDECL Enclave_ocall_Start_Timer(void* pms)
{
...
static const struct {
	...
	12,
	{
		...
		(void*)Enclave_ocall_Start_Timer,
...
sgx_status_t ecall_load_cache_hit(sgx_enclave_id_t eid, double* M1, size_t size_m1)
{
	sgx_status_t status;
	ms_ecall_load_cache_hit_t ms;
	ms.ms_M1 = M1;
	ms.ms_size_m1 = size_m1;
	status = sgx_ecall(eid, 0, &ocall_table_Enclave, &ms);
	return status;
}

sgx_status_t ecall_load_cache_miss(sgx_enclave_id_t eid, double* M1, size_t size_m1)
{
	sgx_status_t status;
	ms_ecall_load_cache_miss_t ms;
	ms.ms_M1 = M1;
	ms.ms_size_m1 = size_m1;
...
sgx_status_t ecall_store_cache(sgx_enclave_id_t eid, double* M1, size_t size_m1)
{
	sgx_status_t status;
	ms_ecall_store_cache_t ms;
	ms.ms_M1 = M1;
	ms.ms_size_m1 = size_m1;
